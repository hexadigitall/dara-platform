...
module.exports = {
  ...
  theme: {
    extend: {
      // Custom color palette for fashion brand
      colors: {
        primary: {
          50: '#f8fafc',
          100: '#f1f5f9',
  ...
  plugins: [
    ...
    function({ addUtilities }) {
      addUtilities({
        '.sr-only-focusable': {
          '@apply sr-only focus:not-sr-only focus:absolute focus:top-0 focus:left-0 focus:z-50 focus:p-3 focus:bg-white focus:text-black': {},
        },
        '.skip-link': {
          '@apply sr-only-focusable bg-accent-600 text-white px-4 py-2 rounded-md': {},
        },
      })
    },
  ],
